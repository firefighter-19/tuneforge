...
//!
//! Работает только под feature `ecu-tools` (тянет `tuneforge-kernel`,
...
use tuneforge_io::tactrix::{find_tactrix, TactrixDeviceInfo};
use tuneforge_kernel::dtc_db::dtc_lookup;
use tuneforge_kernel::orchestrator::{
...
fn open_tactrix_can() -> anyhow::Result<tuneforge_io::tactrix::TactrixTransport> {
