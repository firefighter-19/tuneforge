...
pub struct PassThruVtable {
    ...
    pub PassThruConnect: unsafe extern "system" fn(
        DeviceId,
        c_ulong,
        c_ulong,
        c_ulong,
    ...
    pub PassThruReadMsgs: unsafe extern "system" fn(
        ChannelId,
        *mut PassThruMsg,
        *mut c_ulong,
        c_ulong,
    ) -> c_long,
    pub PassThruWriteMsgs: unsafe extern "system" fn(
        ChannelId,
        *const PassThruMsg,
        *mut c_ulong,
        c_ulong,
    ) -> c_long,
    pub PassThruIoctl: unsafe extern "system" fn(
        c_ulong,
        c_ulong,
        *mut c_void,
        *mut c_void,
